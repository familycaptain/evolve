...
Play the **Vision-fit** agent. Canonical instructions: read `agents/prompts/vision-fit.md`.
...
Emit JSON matching `VISION_OUT` (`agents/registry.py`) to `$EVOLVE_STATE_DIR/<id>/vision.json`.
