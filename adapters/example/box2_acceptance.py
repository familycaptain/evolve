#!/usr/bin/env python3
"""Live acceptance harness (Phase 1) — the reusable spine the validation agent drives.
...
Runs on the test host against the live dockerized Skipper.
...
PW = open(os.path.expanduser("~/.qa_pw")).read().strip()
...
# --- built-in demo: varied-phrasing chat over real UI data (reuses the schedule already seeded) ---
DEMO = {
